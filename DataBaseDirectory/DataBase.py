...
LOADED_DB_PATH = r'DataBaseDirectory/db.pickle'
TRACK_NAME = "TRACK"
...
class DataBase:
    ...
    def create_db(self, prev_and_next_frame_features, relative_to_first_cam_trans):
        """
        ...
        frame = Fr.Frame(0, relative_to_first_cam_trans[0])
        ...
        for i, arr in enumerate(prev_and_next_frame_features):
            ...
            self.set_tracks_and_frames(frame_i_features_obj, frame_i_following_features_obj, i, relative_to_first_cam_trans)

    def set_tracks_and_frames(self, first_frame_features_obj, second_frame_features_obj, first_frame_id, relative_to_first_cam_trans):
        """
        ...
        # Creates frame i+1
        frame = Fr.Frame(second_frame_id, relative_to_first_cam_trans[second_frame_id])
        self.add_frame(frame)
